...
// for filtering
export const fetchProductsByFilterAsnc = createAsyncThunk(
...
export const productSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchProductsByFilterAsnc.pending, (state) => {
        state.status = "loading";
      })
      .addCase(fetchProductsByFilterAsnc.fulfilled, (state, action) => {
        state.status = "idle";
...
export const selectedProductsById = (state) => state.product.selectedProducts;
